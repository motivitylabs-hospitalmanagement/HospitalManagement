...
<div class="topnav" id="myTopnav">
  ...
  <a href="doctor_profile.jsp" >DOCTOR_PROFILE</a>
  <a href="show_application.jsp" > SHOW APPLICATIONS</a>
  <a href="view_appiontments.jsp" class="active">VIEW APPOINTMENTS</a>
...
<caption style="background-color: #89d98b;font-family: monospace;font-size: 30px;font-weight: bold;">(-: &nbsp;VIEW-APPLICATIONS &nbsp; :-)</caption>
<br><br>
...
%>
	...
	<td><%=ap.getAptdate() %></td>
	<td><%=ap.getTime() %></td>
	<td><input type="submit" value="delete" style="border-radius: 5px;color: aqua;"></td>
	</tr>
